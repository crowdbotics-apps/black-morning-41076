"""
Django settings for black_morning_41076 project.
...
ROOT_URLCONF = 'black_morning_41076.urls'
...
WSGI_APPLICATION = 'black_morning_41076.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_morning_41076 API",
    "DESCRIPTION": "API documentation for black_morning_41076 App",
    "VERSION": "v1",
}
